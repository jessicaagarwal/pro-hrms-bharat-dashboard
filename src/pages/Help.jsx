...
/**
 * @typedef {Object} HelpTopicProps
 * @property {string} title - The title of the help topic
 * @property {string} description - The description of the help topic
 * @property {string[]} topics - Array of related topics
 */

/**
 * Help Topic component for displaying help information
 * @param {HelpTopicProps} props - Component props
 */
function HelpTopic({ title, description, topics }) {
  return (
...
// PropTypes for the Help component if it receives any props
Help.propTypes = {
